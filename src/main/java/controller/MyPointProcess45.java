        ...
        for (int j = 0; j < yEnd; j++) {
            for (int i = xEnd; i < image_dest.getWidth(); i++) {
                if (image_dest.getRGB(i, list.get(j).y) != -1) {
                    ...
                    if (i < xEnd) {    /*System.out.print("Q");*/ } else if (i <= list.get(j).x || i == xEnd) {
                        allBlackPoint = new Point(i, j);
                        listPoint.add(allBlackPoint);
                        //System.out.print("0");
                        x_sum += i;
        ...
        for (int j = 0; j < yEnd; j++) {
            for (int i = xEnd; i < image_dest.getWidth(); i++) {
                if (image_dest.getRGB(i, list.get(j).y) != -1) {
                    ...
                    if (i < list.get(j).x) {    /*System.out.print("Q");*/ } else if (i >= list.get(j).y) {
        ...
        for (int j = yEnd; j <= image_dest.getHeight(); j++) {
            for (int i = 0; i <= xEnd; i++) {
                if (image_dest.getRGB(i, j) != -1) {
                    ...
                    if (i < list.get(jCount).x) {    /*System.out.print("Q");*/ } else if (i >= list.get(jCount).x && i <= xEnd) {
                        //System.out.print(i+" ,"+p.y+" ");
                        allBlackPoint = new Point(i, j);
                        listPoint.add(allBlackPoint);
//						System.out.print("0");
        ...
        for (int j = yEnd; j <= image_dest.getHeight(); j++) {
            for (int i = xEnd; i < image_dest.getWidth(); i++) {
                if (image_dest.getRGB(i, j) != -1) {
                    ...
                    if (i < xEnd) {    /*System.out.print("Q");*/ } else if (i <= list.get(jCount).x) {
                        //System.out.print(i+" ,"+p.y+" ");
                        allBlackPoint = new Point(i, j);
                        listPoint.add(allBlackPoint);
//						System.out.print("0");
